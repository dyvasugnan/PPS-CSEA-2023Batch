...

{
    ...
    while(fscanf(fileOpen,"%d %s %d/%d/%d %d  %s %lf %s %f %d/%d/%d\n",&adding.account_number,adding.client_name,&adding.client_dob.mm,&adding.client_dob.dd,&adding.client_dob.yy,&adding.client_age,adding.client_address,&adding.client_phone,adding.client_account_type,&adding.client_amount,&adding.client_deposit.mm,&adding.client_deposit.dd,&adding.client_deposit.yy)!=EOF)
    {
    ...
    scanf("%s",adding.client_account_type);
        ...
        fprintf(fileOpen,"%d %s %d/%d/%d %d %s %s %lf %s %f %d/%d/%d\n",adding.account_number,adding.client_name,adding.client_dob.mm,adding.client_dob.dd,adding.client_dob.yy,adding.client_age,adding.client_address,adding.client_phone,adding.client_account_type,adding.client_amount,adding.client_deposit.mm,adding.client_deposit.dd,adding.client_deposit.yy);
...
void view_list()
{
    ...
    while(fscanf(viewing,"%d %s %d/%d/%d %d  %s %lf %s %f %d/%d/%d",&adding.account_number,adding.client_name,&adding.client_dob.mm,&adding.client_dob.dd,&adding.client_dob.yy,&adding.client_age,adding.client_address,&adding.client_phone,adding.client_account_type,&adding.client_amount,&adding.client_deposit.mm,&adding.client_deposit.dd,&adding.client_deposit.yy)!=EOF)
       {
...
void update(void)
{
    ...
    while(fscanf(oldrecord,"%d %s %d/%d/%d %d  %s %lf %s %f %d/%d/%d",&adding.account_number,adding.client_name,&adding.client_dob.mm,&adding.client_dob.dd,&adding.client_dob.yy,&adding.client_age,adding.client_address,&adding.client_phone,adding.client_account_type,&adding.client_amount,&adding.client_deposit.mm,&adding.client_deposit.dd,&adding.client_deposit.yy)!=EOF)
    {
        ...
        {   tst=1;
            ...
            if(options==1)
                ...
                fprintf(newrecord,"%d %s %d/%d/%d %d  %s %lf %s %f %d/%d/%d\n",adding.account_number,adding.client_name,adding.client_dob.mm,adding.client_dob.dd,adding.client_dob.yy,adding.client_age,updating.client_address,adding.client_phone,adding.client_account_type,adding.client_amount,adding.client_deposit.mm,adding.client_deposit.dd,adding.client_deposit.yy);
                system("cls");
                ...
                fprintf(newrecord,"%d %s %d/%d/%d %d  %s %lf %s %f %d/%d/%d\n",adding.account_number,adding.client_name,adding.client_dob.mm,adding.client_dob.dd,adding.client_dob.yy,adding.client_age,adding.client_address,updating.client_phone,adding.client_account_type,adding.client_amount,adding.client_deposit.mm,adding.client_deposit.dd,adding.client_deposit.yy);
                system("cls");
                printf("Changes saved!");
                }
...
void see(void)
{
    ...
    {   printf("Enter the account number:");
        ...
        while (fscanf(openFile,"%d %s %d/%d/%d %d  %s %lf %s %f %d/%d/%d",&adding.account_number,&adding.client_name,&adding.client_dob.mm,&adding.client_dob.dd,&adding.client_dob.yy,&adding.client_age,&adding.client_address,&adding.client_phone,&adding.client_account_type,&adding.client_amount,&adding.client_deposit.mm,&adding.client_deposit.dd,&adding.client_deposit.yy)!=EOF)
        {
            if(adding.account_number==checking.account_number)
            {   system("cls");
                tst=1;

                printf("\nAccount NO.:%d\nName:%s \nDOB:%d/%d/%d \nAge:%d \nAddress:%s \nCitizenship No:%s \nPhone number:%.0lf \nType Of Account:%s \nAmount deposited:P %.2f \nDate Of Deposit:%d/%d/%d\n\n",adding.account_number,adding.client_name,adding.client_dob.mm,adding.client_dob.dd,adding.client_dob.yy,adding.client_age,adding.client_address,adding.client_phone,
